...
abstract class StandaloneRemoteDataSource {
  Future<StandaloneModel> StandaloneData({
    required int userId,
...
class StandaloneRemoteDataSourceImpl extends StandaloneRemoteDataSource {
  final ApiClient apiClient;

  StandaloneRemoteDataSourceImpl({required this.apiClient});
  ...
  Future<StandaloneModel> StandaloneData({
    ...
    try {
      ...
      if (response["code"] == 200) {
        return StandaloneModel.fromJson(response);
      }
