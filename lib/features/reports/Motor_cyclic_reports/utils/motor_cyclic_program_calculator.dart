...
class MotorCyclicProgramCalculator {
  // ---------------- PROGRAM TOTAL FLOW ----------------
  static double programTotalFlow(MotoCyclicDatumEntity program) {
    double total = 0;
  ...
  static String programTotalDuration(MotoCyclicDatumEntity program) {
    int totalSeconds = 0;
