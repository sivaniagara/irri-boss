class PumpSettingsUrls {
  ...
  static const String getSettingsMenuForPumpPro = 'user/:userId/subuser/:subuserId/controller/:controllerId/menu/$settingReferenceIdForPumpPro/$newSettings';
  ...
  static const String getFinalMenuForPumpPro = 'user/:userId/subuser/:subuserId/controller/:controllerId/menu/$settingReferenceIdForPumpPro/$newSettings/:menuId';
  ...
  static const String updateTemplateForPumpPro = 'user/:userId/subuser/:subuserId/controller/:controllerId/menu/$settingReferenceIdForPumpPro/$newSettings';
