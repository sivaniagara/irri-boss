...
import 'package:niagara_smart_drip_irrigation/features/program_settings/sub_module/edit_zone/domain/entities/node_entity.dart';
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            CustomMaterialButton(
                                onPressed: (){
                                  if(state.submitMode == SubmitMode.whenAdd){
                                    context.read<EditZoneBloc>().add(SubmitZone());
                                  }else{
                                    context.read<EditZoneBloc>().add(SubmitWhileEditZone());
                                  }
